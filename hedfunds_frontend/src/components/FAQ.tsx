...
const FAQ: React.FC = () => {
  const cardData: CardProps[] = [
    {
      title: "What is HedFunds ?",
      contents: [
        "HedFunds is a decentralized platform that lets people borrow and lend money directly with each other using blockchain technology. No banks, no middlemen — just fast, fair loans secured by smart contracts on Hedera."
      ],
      rotate: "rotate-2",
      lastCard: false,
      index: 0,
    },
    {
      ...
      contents: [
        "Unlike banks or loan apps that require paperwork, collateral, or charge high fees, HedFunds works purely on trust scores and blockchain automation. That means no delays, no bias — and full transparency."
      ],
      rotate: "-rotate-2",
      lastCard: false,
      index: 1,
    ...
    {
      title: "How do smart contracts work in HedFunds?",
      contents: [
    ...
    },
    {
      ...
      contents: [
        "It’s a decentralized trust rating based on your actions on HedFunds — like timely repayment, successful loans funded, or bad behavior (missed payments, scams). The better your score, the more people will want to lend to you."
      ],
      rotate: "-rotate-4",
      lastCard: false,
      index: 3,
    ...
    {
      title: "Do I need to stake or lock in funds to use HedFunds?",
      contents: [
    ...
    {
      title: "Can I make money with HedFunds?",
      contents: [
